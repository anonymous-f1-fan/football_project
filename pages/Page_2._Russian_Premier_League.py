...
with st.echo(code_location='below'):
    ...
    то есть с каким счётом заканчивались матчи и как часто. На визуализации ниже вы можете увидеть это."""
    ...
    """Далее предлагаю посмотреть на 10 лучших бомбардиров чемпионата России (то есть на тех, кто забил больше всего) 
    и на то, как распределилсь у этих игроков голы с игры и с пенальти."""
    ...
    Предлагаю при помощи двух следующих визуализаций посмотреть, игроки каких национальностей забивали и как голы распределилсь между ними."""
