...
with st.echo(code_location='below'):
    ...
    st.sidebar.header("Анализ европейских турниров")

    """Теперь я предлагаю перейти от национальных турниров к турнирам, проводящимся между команадами из разных стран."""

    st.subheader("Лига Чемпионов 2021/2022")
    st.sidebar.subheader("Лига Чемпионов 2021/2022")
    ...
    a = st.selectbox('Выберите команду:', CL_2021_teams['name'].unique())
